...
from .models import Contact, ContactGroup, Gender, Vyrobce, Vyrobky
...
class VyrobkyView(ModelView):
    datamodel = SQLAInterface(Vyrobky)
    related_views = [ContactModelView]
...
appbuilder.add_view(
    VyrobkyView, "Vyrobky", icon="fa-dashboard", category="Contacts"
)
appbuilder.add_view(
